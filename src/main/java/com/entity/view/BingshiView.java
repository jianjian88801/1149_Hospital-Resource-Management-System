 ...
 */
@TableName("bingshi")
public class BingshiView extends BingshiEntity implements Serializable {
	...
	public BingshiView(BingshiEntity bingshiEntity) {
		try {
			BeanUtils.copyProperties(this, bingshiEntity);
