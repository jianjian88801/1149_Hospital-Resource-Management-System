    ...
    */
    ...
    public R save(@RequestBody YaopinEntity yaopin, HttpServletRequest request){
        ...
        Wrapper<YaopinEntity> queryWrapper = new EntityWrapper<YaopinEntity>()
            ...
            .eq("yaopin_chyengfen", yaopin.getYaopinChyengfen())
            .eq("yaopin_shiyongfanwei", yaopin.getYaopinShiyongfanwei())
            .eq("yaopin_beizhu", yaopin.getYaopinBeizhu())
...
//                            yaopinEntity.setYaopinChyengfen(data.get(0));                    //主要成分 要改的
//                            yaopinEntity.setYaopinShiyongfanwei(data.get(0));                    //适用范围 要改的
//                            yaopinEntity.setYaopinBeizhu(data.get(0));                    //备注 要改的
//                            yaopinEntity.setYaopinJiangshi(data.get(0));                    //价格 要改的
