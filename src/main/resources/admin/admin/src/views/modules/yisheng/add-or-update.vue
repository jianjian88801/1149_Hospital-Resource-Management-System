    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工作时间" prop="yishengGongzuoshij">
                       <el-input v-model="ruleForm.yishengGongzuoshij"
                                 placeholder="工作时间" clearable  :readonly="ro.yishengGongzuoshij"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="工作时间" prop="yishengGongzuoshij">
                           <el-input v-model="ruleForm.yishengGongzuoshij"
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="简介" prop="yishengContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yishengContent" label="简介" prop="yishengContent">
