    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="病名" prop="bingshiName">
                       <el-input v-model="ruleForm.bingshiName"
                                 placeholder="病名" clearable  :readonly="ro.bingshiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="病名" prop="bingshiName">
                           <el-input v-model="ruleForm.bingshiName"
                                     placeholder="病名" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="病因" prop="bingshiBingyin">
                       <el-input v-model="ruleForm.bingshiBingyin"
                                 placeholder="病因" clearable  :readonly="ro.bingshiBingyin"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="病因" prop="bingshiBingyin">
                           <el-input v-model="ruleForm.bingshiBingyin"
                                     placeholder="病因" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现状" prop="bingshiXianzhuang">
                       <el-input v-model="ruleForm.bingshiXianzhuang"
                                 placeholder="现状" clearable  :readonly="ro.bingshiXianzhuang"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="现状" prop="bingshiXianzhuang">
                           <el-input v-model="ruleForm.bingshiXianzhuang"
                                     placeholder="现状" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="药单" prop="bingshiText">
                        <el-input type="textarea"  :readonly="ro.bingshiText" v-model="ruleForm.bingshiText" placeholder="药单"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.bingshiText" label="药单" prop="bingshiText">
                            <span v-html="ruleForm.bingshiText"></span>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="禁忌" prop="bingshiJinji">
                       <el-input v-model="ruleForm.bingshiJinji"
                                 placeholder="禁忌" clearable  :readonly="ro.bingshiJinji"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="禁忌" prop="bingshiJinji">
                           <el-input v-model="ruleForm.bingshiJinji"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="注意事项" prop="bingshiZhuyishixiang">
                       <el-input v-model="ruleForm.bingshiZhuyishixiang"
                                 placeholder="注意事项" clearable  :readonly="ro.bingshiZhuyishixiang"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="注意事项" prop="bingshiZhuyishixiang">
                           <el-input v-model="ruleForm.bingshiZhuyishixiang"
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    yonghuId: false,
                    bingshiName: false,
                    bingshiBingyin: false,
                    bingshiXianzhuang: false,
                    bingshiText: false,
                    bingshiJinji: false,
                    bingshiZhuyishixiang: false,
                },
                ruleForm: {
                    yishengId: '',
                    yonghuId: '',
                    ...
                    bingshiText: '',
                    bingshiJinji: '',
                    bingshiZhuyishixiang: '',
                },
                yishengOptions : [],
                yonghuOptions : [],
                rules: {
                   yishengId: [
                              { required: true, message: '发布医生不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   bingshiBingyin: [
                              { required: true, message: '病因不能为空', trigger: 'blur' },
                          ],
                   bingshiXianzhuang: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`bingshi/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.bingshiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
