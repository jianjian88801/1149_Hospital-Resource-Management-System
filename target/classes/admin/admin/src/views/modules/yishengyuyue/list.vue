        ...
        <el-dialog title="审核" :visible.sync="yishengyuyueYesnoTypesVisible">
            <el-form :model="form">
                ...
                <el-form-item label="审核" >
                    <el-select v-model="form.yishengyuyueYesnoTypes" placeholder="请选择审核类型">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="yishengyuyueYesnoTypesShenhe">提 交</el-button>
            </div>
        </el-dialog>
        <!-- 条件查询 -->
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/yiyuanziyuanguanli/upload/yishengyuyueMuBan.xls"
                        >批量导入医生预约数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yishengyuyue','导入导出')"
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :"yishengyuyue",//当前表表名,
                        sumColum : 'yishengyuyue_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'yishengyuyue_name',//分组字符串字段
                        // types : 'yishengyuyue_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
                ...
                //         groupColumn: "yishengyuyue_types",
                //     }
                //     this.$http({
            ...
            openYesnoTypes(id) {
                let _this = this;
                _this.form.id = id;
                _this.form.yishengyuyueYesnoTypes = "请选择审核结果";
                _this.yishengyuyueYesnoTypesVisible = true;
            },

            yishengyuyueYesnoTypesShenhe() {
                let _this = this;
                if(_this.form.yishengyuyueYesnoTypes == "请选择审核结果"){
                    alert("请选择审核结果");
                    return false;
                }
                this.$http({
