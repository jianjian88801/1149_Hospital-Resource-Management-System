  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yisheng'"  label='工作时间' prop="yishengGongzuoshij">
               <el-input v-model="ruleForm.yishengGongzuoshij"  placeholder='工作时间' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="24">
             <el-form-item v-if="flag=='yisheng'"  label="简介" prop="yishengContent">
                 <editor
...
// 注册表 医生 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yishengGongzuoshij)&& 'yisheng'==this.flag){
